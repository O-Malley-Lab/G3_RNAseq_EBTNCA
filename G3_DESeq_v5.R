# 11/15/2023
# final proofread of complete DESeq analysis on G3 count matrix-- the supplement heatmaps not the manuscript one
...
# Import the excel file comparing all samples ot each other and remove the genes with padj <0.05
